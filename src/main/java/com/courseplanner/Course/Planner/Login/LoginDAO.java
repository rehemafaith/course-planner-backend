package com.courseplanner.Course.Planner.Login;
...
public class LoginDAO {
	PreparedStatement cst = null;
	  ...
	  public List<LoginBean> fetchLoginDetails() throws SQLException {
		    ...
		    try {
		      ...
		      while (rs.next()) {
		        ...
		        fetch.setLoginUsername(rs.getString("login_username"));
		        fetch.setLoginPassword(rs.getString("login_password"));
	  ...
	  public List<LoginBean> createLoginDetails(LoginBean loginBean) throws SQLException {
		    String sql = "INSERT INTO login(login_id, login_username, login_password, login_rank) VALUES ( "+ getNextPrimaryKey() +",'"+ loginBean.getLoginUsername() +"','"+ loginBean.getLoginPassword()+"','"+ loginBean.getLoginRank()+"')";
		    try { 
		      this.conn = this.dataSource.getConnection();
	...
	//update login information
	  public List<LoginBean> updateLoginDetails(LoginBean loginBean) throws SQLException {
		    String sql = "update login set login_username='" + loginBean.getLoginUsername()  + "',login_password='" + loginBean.getLoginPassword()+ "', login_rank='" + loginBean.getLoginRank()+"' where login_id=" + loginBean.getLoginId();
